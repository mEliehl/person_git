System.register(['angular2/core', 'angular2/platform/browser', 'angular2/router', 'angular2/http', './app.component', "./services/dataService", "./services/personService", 'rxjs/Rx'], function(exports_1) {
